    ...
    [
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink("System 1 - Genre", href="/system-1", active="exact"),
...
def render_page_content(pathname):
    if pathname == "/":
        return html.Div(
            [
                html.H1("Movie Recommendation Systems"),
                html.P("Choose a recommendation system:"),
                dcc.Link("System 1 - Genre", href="/system-1", className="btn btn-primary m-2"),
                dcc.Link("System 2 - Collaborative", href="/system-2", className="btn btn-primary m-2"),
                html.Div([
                    html.H2("System 1 - Genre"),
                    html.P("System 1: Get movie recommendations by your favorite genre"),
                    html.Hr(),
                    html.H2("System 2 - Collaborative"),
                    html.P("System 2: Rate some movies, and get recommendations for similar movies"),
                ])
            ]
        )
    elif pathname == "/system-1":
        return html.Div(
            [
